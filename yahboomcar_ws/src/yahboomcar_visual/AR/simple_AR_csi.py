...
if __name__ == '__main__':
    ...
    capture = cv.VideoCapture("nvarguscamerasrc\!  video/x-raw(memory:NVMM),width=640, height=480, format=NV12,framerate=20/1\!  nwwidconv flip-method=0 !  videoconvert !video/x-raw, format=BGR !  appsink" )
